...
/**
 * Получить данные из localStorage или вернуть значение по умолчанию.
...
function getBlacklist() {
    return getFromStorage('blacklist', []);
}

/**
 * Проверить, находится ли канал в "Чёрном списке".
 * @param {string} name - Название канала.
 * @returns {boolean} true, если канал в чёрном списке, иначе false.
 */
...
function removeFromBlacklist(name) {
    ...
    if (index > -1) {
        ...
        console.log(`✅ Канал "${name}" удалён из "Чёрного списка"`);
    }
}

// =============================
// Функции для "Просмотренных"
// =============================

/**
 * Добавить канал в "Просмотренные".
 * @param {string} name - Название канала.
 * @param {string} url - URL плейлиста или прямой ссылки на канал.
 */
function addToWatched(name, url) {
    if (!name || !url) return; // Защита от пустых значений
...
/**
 * Получить список просмотренных каналов.
 * @returns {Object} Объект, где ключ - название канала, значение - URL.
 */
function getWatchedChannels() {
    return getFromStorage('watchedChannels', {});
}

/**
 * Проверить, смотрели ли канал.
 * @param {string} name - Название канала.
 * @returns {boolean} true, если канал смотрели, иначе false.
 */
function isWatched(name) {
    const watched = getFromStorage('watchedChannels', {});
    return watched.hasOwnProperty(name);
}

/**
 * Удалить канал из "Просмотренных".
 * @param {string} name - Название канала.
 */
function removeFromWatched(name) {
    const watched = getFromStorage('watchedChannels', {});
    if (watched.hasOwnProperty(name)) {
        delete watched[name];
        saveToStorage('watchedChannels', watched);
        if (typeof categoryTree !== 'undefined') {
            categoryTree["Просмотренные"] = watched;
        }
        console.log(`🗑️ Канал "${name}" удалён из "Просмотренных"`);
    }
}

// =============================
// Основной объект categoryTree
// =============================
...
//
// // Проверить, смотрели ли канал
// if (isWatched("CNN International")) {
//     console.log("Вы уже смотрели этот канал!");
// }
//
// // Получить все просмотренные каналы
// console.log("Ваши просмотренные каналы:", categoryTree["Просмотренные"]);
//
// // Получить весь чёрный список
// console.log("Ваш чёрный список:", categoryTree["Чёрный список"]);

// =============================
// Экспорт (если используется в модуле)
// =============================
