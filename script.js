...
const translations = {
  ru: {
    ...
    "Ошибка загрузки рейтинга": "Ошибка загрузки рейтинга",
    "Ошибка загрузки каналов": "Ошибка загрузки каналов",
    "Не удалось загрузить каналы": "Не удалось загрузить каналы",

    // === Категории ===
    "Авто": "Авто", "Анимация": "Анимация", "Бизнес": "Бизнес", "Детские": "Детские", "Документальные": "Документальные", "Законодательные": "Законодательные", "Интерактивные": "Интерактивные", "Кино": "Кино", "Классика": "Классика", "Комедии": "Комедии", "Кулинария": "Кулинария", "Культура": "Культура", "Музыка": "Музыка", "Наука": "Наука", "Новости": "Новости", "Образ жизни": "Образ жизни", "Образование": "Образование", "Общие": "Общие", "Погода": "Погода", "Развлечения": "Развлечения", "Религиозные": "Религиозные", "Релакс": "Релакс", "Семейные": "Семейные", "Сериалы": "Сериалы", "Спорт": "Спорт", "Шопинг": "Шопинг", "Путешествия": "Путешествия", "Общественные": "Общественные", "Активный отдых": "Активный отдых", "XXX": "XXX",

    // === Страны ===
    "Австралия": "Австралия", "Австрия": "Австрия", "Азербайджан": "Азербайджан", "Албания": "Албания", "Алжир": "Алжир", "Ангола": "Ангола", "Андорра": "Андорра", "Аргентина": "Аргентина", "Армения": "Армения", "Афганистан": "Афганистан", "Багамы": "Багамы", "Бангладеш": "Бангладеш", "Барбадос": "Барбадос", "Бахрейн": "Бахрейн", "Беларусь": "Беларусь", "Бенин": "Бенин", "Бермуды": "Бермуды", "Болгария": "Болгария", "Боливия": "Боливия", "Бонайре": "Бонайре", "Босния и Герцеговина": "Босния и Герцеговина", "Бразилия": "Бразилия", "Британские Виргинские острова": "Британские Виргинские острова", "Бруней": "Бруней", "Буркина-Фасо": "Буркина-Фасо", "Бутан": "Бутан", "Ватикан": "Ватикан", "Великобритания": "Великобритания", "Венгрия": "Венгрия", "Венесуэла": "Венесуэла", "Вьетнам": "Вьетнам", "Гаити": "Гаити", "Гайана": "Гайана", "Гамбия": "Гамбия", "Гана": "Гана", "Гваделупа": "Гваделупа", "Гватемала": "Гватемала", "Гвинея": "Гвинея", "Гернси": "Гернси", "Германия": "Германия", "Гондурас": "Гондурас", "Гонконг": "Гонконг", "Греция": "Греция", "Грузия": "Грузия", "Гуам": "Гуам", "Дания": "Дания", "Демократическая Республика Конго": "Демократическая Республика Конго", "Джибути": "Джибути", "Доминиканская Республика": "Доминиканская Республика", "Египет": "Египет", "Западная Сахара": "Западная Сахара", "Зимбабве": "Зимбабве", "Израиль": "Израиль", "Индия": "Индия", "Индонезия": "Индонезия", "Иордания": "Иордания", "Ирак": "Ирак", "Иран": "Иран", "Ирландия": "Ирландия", "Исландия": "Исландия", "Испания": "Испания", "Италия": "Италия", "Йемен": "Йемен", "Кабо-Верде": "Кабо-Верде", "Казахстан": "Казахстан", "Камбоджа": "Камбоджа", "Камерун": "Камерун", "Канада": "Канада", "Катар": "Катар", "Кения": "Кения", "Кипр": "Кипр", "Киргизия": "Киргизия", "Китай": "Китай", "Колумбия": "Колумбия", "Коморы": "Коморы", "Конго": "Конго", "Косово": "Косово", "Коста-Рика": "Коста-Рика", "Кот-д'Ивуар": "Кот-д'Ивуар", "Куба": "Куба", "Кувейт": "Кувейт", "Кюрасао": "Кюрасао", "Лаос": "Лаос", "Латвия": "Латвия", "Лесото": "Лесото", "Ливан": "Ливан", "Ливия": "Ливия", "Литва": "Литва", "Лихтенштейн": "Лихтенштейн", "Люксембург": "Люксембург", "Маврикий": "Маврикий", "Мавритания": "Мавритания", "Мадагаскар": "Мадагаскар", "Макао": "Макао", "Малави": "Малави", "Малайзия": "Малайзия", "Мали": "Мали", "Мальдивы": "Мальдивы", "Мальта": "Мальта", "Марокко": "Марокко", "Мартиника": "Мартиника", "Мексика": "Мексика", "Мозамбик": "Мозамбик", "Молдова": "Молдова", "Монако": "Монако", "Монголия": "Монголия", "Мьянма": "Мьянма", "Намибия": "Намибия", "Непал": "Непал", "Нигер": "Нигер", "Нигерия": "Нигерия", "Нидерланды": "Нидерланды", "Никарагуа": "Никарагуа", "Новая Зеландия": "Новая Зеландия", "Норвегия": "Норвегия", "ОАЭ": "ОАЭ", "Оман": "Оман", "Пакистан": "Пакистан", "Палестина": "Палестина", "Панама": "Панама", "Папуа — Новая Гвинея": "Папуа — Новая Гвинея", "Парагвай": "Парагвай", "Перу": "Перу", "Польша": "Польша", "Португалия": "Португалия", "Пуэрто-Рико": "Пуэрто-Рико", "Реюньон": "Реюньон", "Россия": "Россия", "Руанда": "Руанда", "Румыния": "Румыния", "Сальвадор": "Сальвадор", "Самоа": "Самоа", "Сан-Марино": "Сан-Марино", "Саудовская Аравия": "Саудовская Аравия", "Северная Корея": "Северная Корея", "Северная Македония": "Северная Македония", "Сенегал": "Сенегал", "Сент-Китс и Невис": "Сент-Китс и Невис", "Сент-Люсия": "Сент-Люсия", "Сербия": "Сербия", "Сингапур": "Сингапур", "Синт-Мартен": "Синт-Мартен", "Сирия": "Сирия", "Словакия": "Словакия", "Словения": "Словения", "Сомали": "Сомали", "Судан": "Судан", "Суринам": "Суринам", "США": "США", "Таджикистан": "Таджикистан", "Таиланд": "Таиланд", "Тайвань": "Тайвань", "Танзания": "Танзания", "Того": "Того", "Тонга": "Тонга", "Тринидад и Тобаго": "Тринидад и Тобаго", "Тунис": "Тунис", "Туркменистан": "Туркменистан", "Турция": "Турция", "Уганда": "Уганда", "Узбекистан": "Узбекистан", "Украина": "Украина", "Уругвай": "Уругвай", "Фарерские острова": "Фарерские острова", "Фиджи": "Фиджи", "Филиппины": "Филиппины", "Финляндия": "Финляндия", "Франция": "Франция", "Французская Полинезия": "Французская Полинезия", "Хорватия": "Хорватия", "Чад": "Чад", "Черногория": "Черногория", "Чехия": "Чехия", "Чили": "Чили", "Швейцария": "Швейцария", "Швеция": "Швеция", "Шри-Ланка": "Шри-Ланка", "Эквадор": "Эквадор", "Экваториальная Гвинея": "Экваториальная Гвинея", "Эритрея": "Эритрея", "Эстония": "Эстония", "Эфиопия": "Эфиопия", "Южная Африка": "Южная Африка", "Южная Корея": "Южная Корея", "Ямайка": "Ямайка", "Япония": "Япония", "Американские Виргинские острова": "Американские Виргинские острова",

    // === Языки ===
    "Аколи": "Аколи", "Адхола": "Адхола", "Айизо гбе": "Айизо гбе", "Аймара": "Аймара", "Албанский": "Албанский", "Алжирский жестовый": "Алжирский жестовый", "Алур": "Алур", "Амхарский": "Амхарский", "Арабский": "Арабский", "Армянский": "Армянский", "Ассамский": "Ассамский", "Ассирийский неоарамейский": "Ассирийский неоарамейский", "Афар": "Афар", "Африкаанс": "Африкаанс", "Азербайджанский": "Азербайджанский", "Баатонум": "Баатонум", "Бамбара": "Бамбара", "Баскский": "Баскский", "Башкирский": "Башкирский", "Белорусский": "Белорусский", "Бенгальский": "Бенгальский", "Бирманский": "Бирманский", "Боджпури": "Боджпури", "Болгарский": "Болгарский", "Боснийский": "Боснийский", "Валлийский": "Валлийский", "Венгерский": "Венгерский", "Венда": "Венда", "Вьетнамский": "Вьетнамский", "Ганда": "Ганда", "Гаитянский": "Гаитянский", "Ген": "Ген", "Гикую": "Гикую", "Голландский": "Голландский", "Гоан Конкани": "Гоан Конкани", "Греческий": "Греческий", "Грузинский": "Грузинский", "Гуджарати": "Гуджарати", "Гун": "Гун", "Гэльский": "Гэльский", "Датский": "Датский", "Дари (Парси)": "Дари (Парси)", "Денди (Бенин)": "Денди (Бенин)", "Дивехи": "Дивехи", "Дханвар (Непал)": "Дханвар (Непал)", "Дхолуо": "Дхолуо", "Димили": "Димили", "Дьюла": "Дьюла", "Египетский арабский": "Египетский арабский", "Западно-фризский": "Западно-фризский", "Зарма": "Зарма", "Зулу": "Зулу", "Иврит": "Иврит", "Индонезийский": "Индонезийский", "Инуктитут": "Инуктитут", "Ирландский": "Ирландский", "Исекири": "Исекири", "Испанский": "Испанский", "Итальянский": "Итальянский", "Кабийе": "Кабийе", "Кабильский": "Кабильский", "Каннада": "Каннада", "Капампанган": "Капампанган", "Каталанский": "Каталанский", "Казахский": "Казахский", "Кечуа": "Кечуа", "Киньяруанда": "Киньяруанда", "Киргизский": "Киргизский", "Китуба (Конго)": "Китуба (Конго)", "Китайский": "Китайский", "Конго": "Конго", "Конкани (макроязык)": "Конкани (макроязык)", "Корейский": "Корейский", "Кумам": "Кумам", "Курдский": "Курдский", "Ланго (Уганда)": "Ланго (Уганда)", "Латинский": "Латинский", "Лаосский": "Лаосский", "Латышский": "Латышский", "Лингала": "Лингала", "Литовский": "Литовский", "Луба-Лулуа": "Луба-Лулуа", "Лушай": "Лушай", "Люксембургский": "Люксембургский", "Македонский": "Македонский", "Малайский": "Малайский", "Малаялам": "Малаялам", "Мальтийский": "Мальтийский", "Мандарин китайский": "Мандарин китайский", "Мандинка": "Мандинка", "Маори": "Маори", "Маратхи": "Маратхи", "Микенский греческий": "Микенский греческий", "Минь Нань китайский": "Минь Нань китайский", "Монгольский": "Монгольский", "Морисьен": "Морисьен", "Мосси": "Мосси", "Немецкий": "Немецкий", "Непальский": "Непальский", "Норвежский": "Норвежский", "Ньянколе": "Ньянколе", "Ньоро": "Ньоро", "Ория (макроязык)": "Ория (макроязык)", "Панджаби": "Панджаби", "Папьяменто": "Папьяменто", "Персидский": "Персидский", "Польский": "Польский", "Португальский": "Португальский", "Пулаар": "Пулаар", "Пушту": "Пушту", "Румынский": "Румынский", "Русский": "Русский", "Самоанский": "Самоанский", "Сантальский": "Сантальский", "Сент-Люсийский креольский французский": "Сент-Люсийский креольский французский", "Сербский": "Сербский", "Сербо-хорватский": "Сербо-хорватский", "Сингальский": "Сингальский", "Словацкий": "Словацкий", "Словенский": "Словенский", "Сомалийский": "Сомалийский", "Стандартный арабский": "Стандартный арабский", "Суахили": "Суахили", "Свати": "Свати", "Тагальский": "Тагальский", "Таджикский": "Таджикский", "Тайский": "Тайский", "Тамильский": "Тамильский", "Татарский": "Татарский", "Тачавит": "Тачавит", "Ташелхит": "Ташелхит", "Таитянский": "Таитянский", "Телугу": "Телугу", "Тигре": "Тигре", "Тигринья": "Тигринья", "Тибетский": "Тибетский", "Тор": "Тор", "Тумзабт": "Тумзабт", "Турецкий": "Турецкий", "Туркменский": "Туркменский", "Узбекский": "Узбекский", "Уйгурский": "Уйгурский", "Украинский": "Украинский", "Урду": "Урду", "Фарерский": "Фарерский", "Фаталика": "Фаталика", "Филиппинский": "Филиппинский", "Финский": "Финский", "Фон": "Фон", "Французский": "Французский", "Фулах": "Фулах", "Центральный атлас тамазигхт": "Центральный атлас тамазигхт", "Центральный курдский": "Центральный курдский", "Ченуа": "Ченуа", "Чешский": "Чешский", "Чига": "Чига", "Чхаттисгархи": "Чхаттисгархи", "Хауса": "Хауса", "Хинди": "Хинди", "Хмонг": "Хмонг", "Хорасани-турецкий": "Хорасани-турецкий", "Хорватский": "Хорватский", "Цонга": "Цонга", "Черногорский": "Черногорский", "Шведский": "Шведский", "Эве": "Эве", "Эстонский": "Эстонский", "Яванский": "Яванский", "Якутский": "Якутский", "Японский": "Японский", "Йоруба": "Йоруба", "Юкатек Майя": "Юкатек Майя", "Юэ китайский": "Юэ китайский", "Южноафриканский жестовый": "Южноафриканский жестовый", "Южный ндебеле": "Южный ндебеле",

    // === Регионы ===
    "Азия": "Азия", "Азиатско-Тихоокеанский регион": "Азиатско-Тихоокеанский регион", "Америка": "Америка", "Арабский мир": "Арабский мир", "АСЕАН": "АСЕАН", "Африка": "Африка", "Африка к югу от Сахары": "Африка к югу от Сахары", "Балканы": "Балканы", "Бенилюкс": "Бенилюкс", "Ближний Восток": "Ближний Восток", "Ближний Восток и Северная Африка": "Ближний Восток и Северная Африка", "Восточная Азия": "Восточная Азия", "Восточная Африка": "Восточная Африка", "Всемирный": "Всемирный", "Европа": "Европа", "Европа, Ближний Восток и Африка": "Европа, Ближний Восток и Африка", "Европейский союз": "Европейский союз", "Западная Азия": "Западная Азия", "Западная Африка": "Западная Африка", "Западная Европа": "Западная Европа", "Карибы": "Карибы", "Центральная Азия": "Центральная Азия", "Центральная Америка": "Центральная Америка", "Центральная Европа": "Центральная Европа", "Центральная и Восточная Европа": "Центральная и Восточная Европа", "Испаноязычная Америка": "Испаноязычная Америка", "Латинская Америка": "Латинская Америка", "Латинская Америка и Карибы": "Латинская Америка и Карибы", "Магриб": "Магриб", "Океания": "Океания", "Организация Объединённых Наций": "Организация Объединённых Наций", "Северная Америка": "Северная Америка", "Северная Америка (континент)": "Северная Америка (континент)", "Северная Европа": "Северная Европа", "Страны Северной Европы": "Страны Северной Европы", "Совет сотрудничества арабских государств Персидского залива": "Совет сотрудничества арабских государств Персидского залива", "СНГ": "СНГ", "Южная Азия": "Южная Азия", "Южная Америка": "Южная Америка", "Южная Европа": "Южная Европа", "Юго-Восточная Азия": "Юго-Восточная Азия", "Южная Африка": "Южная Африка"
  },
  en: {
    // === UI & System Messages ===
    ...
    "Плейлист успешно добавлен в общую коллекцию!": "Playlist successfully added to the public collection!",
    ...
    "Включите канал на 60+ сек — и вы первым появитесь здесь!": "Turn on a channel for 60+ sec to appear here first!",
    "Прямо сейчас никто не смотрит...": "No one is watching right now...",
    "Включите канал — и станьте первым!": "Turn on a channel and be the first!",
    ...
    "Ошибка загрузки рейтинга": "Failed to load rating",
    "Ошибка загрузки каналов": "Failed to load channels",
    "Не удалось загрузить каналы": "Failed to load channels",

    // === Categories ===
    "Авто": "Cars", "Анимация": "Animation", "Бизнес": "Business", "Детские": "Kids", "Документальные": "Documentary", "Законодательные": "Legislative", "Интерактивные": "Interactive", "Кино": "Movies", "Классика": "Classic", "Комедии": "Comedy", "Кулинария": "Cooking", "Культура": "Culture", "Музыка": "Music", "Наука": "Science", "Новости": "News", "Образ жизни": "Lifestyle", "Образование": "Education", "Общие": "General", "Погода": "Weather", "Развлечения": "Entertainment", "Религиозные": "Religious", "Релакс": "Relax", "Семейные": "Family", "Сериалы": "Series", "Спорт": "Sports", "Шопинг": "Shopping", "Путешествия": "Travel", "Общественные": "Public", "Активный отдых": "Outdoor", "XXX": "Adult",

    // === Countries ===
    "Австралия": "Australia", "Австрия": "Austria", "Азербайджан": "Azerbaijan", "Албания": "Albania", "Алжир": "Algeria", "Ангола": "Angola", "Андорра": "Andorra", "Аргентина": "Argentina", "Армения": "Armenia", "Афганистан": "Afghanistan", "Багамы": "Bahamas", "Бангладеш": "Bangladesh", "Барбадос": "Barbados", "Бахрейн": "Bahrain", "Беларусь": "Belarus", "Бенин": "Benin", "Бермуды": "Bermuda", "Болгария": "Bulgaria", "Боливия": "Bolivia", "Бонайре": "Bonaire", "Босния и Герцеговина": "Bosnia and Herzegovina", "Бразилия": "Brazil", "Британские Виргинские острова": "British Virgin Islands", "Бруней": "Brunei", "Буркина-Фасо": "Burkina Faso", "Бутан": "Bhutan", "Ватикан": "Vatican", "Великобритания": "United Kingdom", "Венгрия": "Hungary", "Венесуэла": "Venezuela", "Вьетнам": "Vietnam", "Гаити": "Haiti", "Гайана": "Guyana", "Гамбия": "Gambia", "Гана": "Ghana", "Гваделупа": "Guadeloupe", "Гватемала": "Guatemala", "Гвинея": "Guinea", "Гернси": "Guernsey", "Германия": "Germany", "Гондурас": "Honduras", "Гонконг": "Hong Kong", "Греция": "Greece", "Грузия": "Georgia", "Гуам": "Guam", "Дания": "Denmark", "Демократическая Республика Конго": "DR Congo", "Джибути": "Djibouti", "Доминиканская Республика": "Dominican Republic", "Египет": "Egypt", "Западная Сахара": "Western Sahara", "Зимбабве": "Zimbabwe", "Израиль": "Israel", "Индия": "India", "Индонезия": "Indonesia", "Иордания": "Jordan", "Ирак": "Iraq", "Иран": "Iran", "Ирландия": "Ireland", "Исландия": "Iceland", "Испания": "Spain", "Италия": "Italy", "Йемен": "Yemen", "Кабо-Верде": "Cape Verde", "Казахстан": "Kazakhstan", "Камбоджа": "Cambodia", "Камерун": "Cameroon", "Канада": "Canada", "Катар": "Qatar", "Кения": "Kenya", "Кипр": "Cyprus", "Киргизия": "Kyrgyzstan", "Китай": "China", "Колумбия": "Colombia", "Коморы": "Comoros", "Конго": "Congo", "Косово": "Kosovo", "Коста-Рика": "Costa Rica", "Кот-д'Ивуар": "Ivory Coast", "Куба": "Cuba", "Кувейт": "Kuwait", "Кюрасао": "Curaçao", "Лаос": "Laos", "Латвия": "Latvia", "Лесото": "Lesotho", "Ливан": "Lebanon", "Ливия": "Libya", "Литва": "Lithuania", "Лихтенштейн": "Liechtenstein", "Люксембург": "Luxembourg", "Маврикий": "Mauritius", "Мавритания": "Mauritania", "Мадагаскар": "Madagascar", "Макао": "Macao", "Малави": "Malawi", "Малайзия": "Malaysia", "Мали": "Mali", "Мальдивы": "Maldives", "Мальта": "Malta", "Марокко": "Morocco", "Мартиника": "Martinique", "Мексика": "Mexico", "Мозамбик": "Mozambique", "Молдова": "Moldova", "Монако": "Monaco", "Монголия": "Mongolia", "Мьянма": "Myanmar", "Намибия": "Namibia", "Непал": "Nepal", "Нигер": "Niger", "Нигерия": "Nigeria", "Нидерланды": "Netherlands", "Никарагуа": "Nicaragua", "Новая Зеландия": "New Zealand", "Норвегия": "Norway", "ОАЭ": "UAE", "Оман": "Oman", "Пакистан": "Pakistan", "Палестина": "Palestine", "Панама": "Panama", "Папуа — Новая Гвинея": "Papua New Guinea", "Парагвай": "Paraguay", "Перу": "Peru", "Польша": "Poland", "Португалия": "Portugal", "Пуэрто-Рико": "Puerto Rico", "Реюньон": "Réunion", "Россия": "Russia", "Руанда": "Rwanda", "Румыния": "Romania", "Сальвадор": "El Salvador", "Самоа": "Samoa", "Сан-Марино": "San Marino", "Саудовская Аравия": "Saudi Arabia", "Северная Корея": "North Korea", "Северная Македония": "North Macedonia", "Сенегал": "Senegal", "Сент-Китс и Невис": "Saint Kitts and Nevis", "Сент-Люсия": "Saint Lucia", "Сербия": "Serbia", "Сингапур": "Singapore", "Синт-Мартен": "Sint Maarten", "Сирия": "Syria", "Словакия": "Slovakia", "Словения": "Slovenia", "Сомали": "Somalia", "Судан": "Sudan", "Суринам": "Suriname", "США": "USA", "Таджикистан": "Tajikistan", "Таиланд": "Thailand", "Тайвань": "Taiwan", "Танзания": "Tanzania", "Того": "Togo", "Тонга": "Tonga", "Тринидад и Тобаго": "Trinidad and Tobago", "Тунис": "Tunisia", "Туркменистан": "Turkmenistan", "Турция": "Turkey", "Уганда": "Uganda", "Узбекистан": "Uzbekistan", "Украина": "Ukraine", "Уругвай": "Uruguay", "Фарерские острова": "Faroe Islands", "Фиджи": "Fiji", "Филиппины": "Philippines", "Финляндия": "Finland", "Франция": "France", "Французская Полинезия": "French Polynesia", "Хорватия": "Croatia", "Чад": "Chad", "Черногория": "Montenegro", "Чехия": "Czechia", "Чили": "Chile", "Швейцария": "Switzerland", "Швеция": "Sweden", "Шри-Ланка": "Sri Lanka", "Эквадор": "Ecuador", "Экваториальная Гвинея": "Equatorial Guinea", "Эритрея": "Eritrea", "Эстония": "Estonia", "Эфиопия": "Ethiopia", "Южная Африка": "South Africa", "Южная Корея": "South Korea", "Ямайка": "Jamaica", "Япония": "Japan", "Американские Виргинские острова": "US Virgin Islands",

    // === Languages ===
    "Аколи": "Acholi", "Адхола": "Adhola", "Айизо гбе": "Ayizo Gbe", "Аймара": "Aymara", "Албанский": "Albanian", "Алжирский жестовый": "Algerian Sign", "Алур": "Alur", "Амхарский": "Amharic", "Арабский": "Arabic", "Армянский": "Armenian", "Ассамский": "Assamese", "Ассирийский неоарамейский": "Assyrian Neo-Aramaic", "Афар": "Afar", "Африкаанс": "Afrikaans", "Азербайджанский": "Azerbaijani", "Баатонум": "Baatonum", "Бамбара": "Bambara", "Баскский": "Basque", "Башкирский": "Bashkir", "Белорусский": "Belarusian", "Бенгальский": "Bengali", "Бирманский": "Burmese", "Боджпури": "Bhojpuri", "Болгарский": "Bulgarian", "Боснийский": "Bosnian", "Валлийский": "Welsh", "Венгерский": "Hungarian", "Венда": "Venda", "Вьетнамский": "Vietnamese", "Ганда": "Ganda", "Гаитянский": "Haitian", "Ген": "Gen", "Гикую": "Kikuyu", "Голландский": "Dutch", "Гоан Конкани": "Goan Konkani", "Греческий": "Greek", "Грузинский": "Georgian", "Гуджарати": "Gujarati", "Гун": "Gun", "Гэльский": "Gaelic", "Датский": "Danish", "Дари (Парси)": "Dari (Parsi)", "Денди (Бенин)": "Dendi", "Дивехи": "Dhivehi", "Дханвар (Непал)": "Dhanwar", "Дхолуо": "Dholuo", "Димили": "Dimili", "Дьюла": "Dyula", "Египетский арабский": "Egyptian Arabic", "Западно-фризский": "West Frisian", "Зарма": "Zarma", "Зулу": "Zulu", "Иврит": "Hebrew", "Индонезийский": "Indonesian", "Инуктитут": "Inuktitut", "Ирландский": "Irish", "Исекири": "Isekiri", "Испанский": "Spanish", "Итальянский": "Italian", "Кабийе": "Kabiye", "Кабильский": "Kabyle", "Каннада": "Kannada", "Капампанган": "Kapampangan", "Каталанский": "Catalan", "Казахский": "Kazakh", "Кечуа": "Quechua", "Киньяруанда": "Kinyarwanda", "Киргизский": "Kyrgyz", "Китуба (Конго)": "Kituba", "Китайский": "Chinese", "Конго": "Kongo", "Конкани (макроязык)": "Konkani", "Корейский": "Korean", "Кумам": "Kumam", "Курдский": "Kurdish", "Ланго (Уганда)": "Lango", "Латинский": "Latin", "Лаосский": "Lao", "Латышский": "Latvian", "Лингала": "Lingala", "Литовский": "Lithuanian", "Луба-Лулуа": "Luba-Lulua", "Лушай": "Lushai", "Люксембургский": "Luxembourgish", "Македонский": "Macedonian", "Малайский": "Malay", "Малаялам": "Malayalam", "Мальтийский": "Maltese", "Мандарин китайский": "Mandarin Chinese", "Мандинка": "Mandinka", "Маори": "Maori", "Маратхи": "Marathi", "Микенский греческий": "Mycenaean Greek", "Минь Нань китайский": "Min Nan Chinese", "Монгольский": "Mongolian", "Морисьен": "Morisyen", "Мосси": "Mossi", "Немецкий": "German", "Непальский": "Nepali", "Норвежский": "Norwegian", "Ньянколе": "Nyankole", "Ньоро": "Nyoro", "Ория (макроязык)": "Odia", "Панджаби": "Punjabi", "Папьяменто": "Papiamento", "Персидский": "Persian", "Польский": "Polish", "Португальский": "Portuguese", "Пулаар": "Pulaar", "Пушту": "Pashto", "Румынский": "Romanian", "Русский": "Russian", "Самоанский": "Samoan", "Сантальский": "Santali", "Сент-Люсийский креольский французский": "Saint Lucian Creole French", "Сербский": "Serbian", "Сербо-хорватский": "Serbo-Croatian", "Сингальский": "Sinhala", "Словацкий": "Slovak", "Словенский": "Slovenian", "Сомалийский": "Somali", "Стандартный арабский": "Standard Arabic", "Суахили": "Swahili", "Свати": "Swati", "Тагальский": "Tagalog", "Таджикский": "Tajik", "Тайский": "Thai", "Тамильский": "Tamil", "Татарский": "Tatar", "Тачавит": "Shawiya", "Ташелхит": "Tachelhit", "Таитянский": "Tahitian", "Телугу": "Telugu", "Тигре": "Tigre", "Тигринья": "Tigrinya", "Тибетский": "Tibetan", "Тор": "Tor", "Тумзабт": "Tumzabt", "Турецкий": "Turkish", "Туркменский": "Turkmen", "Узбекский": "Uzbek", "Уйгурский": "Uyghur", "Украинский": "Ukrainian", "Урду": "Urdu", "Фарерский": "Faroese", "Фаталика": "Fataleka", "Филиппинский": "Filipino", "Финский": "Finnish", "Фон": "Fon", "Французский": "French", "Фулах": "Fulah", "Центральный атлас тамазигхт": "Central Atlas Tamazight", "Центральный курдский": "Central Kurdish", "Ченуа": "Chenoua", "Чешский": "Czech", "Чига": "Chiga", "Чхаттисгархи": "Chhattisgarhi", "Хауса": "Hausa", "Хинди": "Hindi", "Хмонг": "Hmong", "Хорасани-турецкий": "Khorasani Turkish", "Хорватский": "Croatian", "Цонга": "Tsonga", "Черногорский": "Montenegrin", "Шведский": "Swedish", "Эве": "Ewe", "Эстонский": "Estonian", "Яванский": "Javanese", "Якутский": "Yakut", "Японский": "Japanese", "Йоруба": "Yoruba", "Юкатек Майя": "Yucatec Maya", "Юэ китайский": "Yue Chinese", "Южноафриканский жестовый": "South African Sign", "Южный ндебеле": "Southern Ndebele",

    // === Regions ===
    "Азия": "Asia", "Азиатско-Тихоокеанский регион": "Asia-Pacific", "Америка": "Americas", "Арабский мир": "Arab World", "АСЕАН": "ASEAN", "Африка": "Africa", "Африка к югу от Сахары": "Sub-Saharan Africa", "Балканы": "Balkans", "Бенилюкс": "Benelux", "Ближний Восток": "Middle East", "Ближний Восток и Северная Африка": "MENA", "Восточная Азия": "East Asia", "Восточная Африка": "East Africa", "Всемирный": "Worldwide", "Европа": "Europe", "Европа, Ближний Восток и Африка": "EMEA", "Европейский союз": "European Union", "Западная Азия": "West Asia", "Западная Африка": "West Africa", "Западная Европа": "Western Europe", "Карибы": "Caribbean", "Центральная Азия": "Central Asia", "Центральная Америка": "Central America", "Центральная Европа": "Central Europe", "Центральная и Восточная Европа": "Central and Eastern Europe", "Испаноязычная Америка": "Hispanic America", "Латинская Америка": "Latin America", "Латинская Америка и Карибы": "Latin America and Caribbean", "Магриб": "Maghreb", "Океания": "Oceania", "Организация Объединённых Наций": "United Nations", "Северная Америка": "North America", "Северная Америка (континент)": "North America (continent)", "Северная Европа": "Northern Europe", "Страны Северной Европы": "Nordic Countries", "Совет сотрудничества арабских государств Персидского залива": "GCC", "СНГ": "CIS", "Южная Азия": "South Asia", "Южная Америка": "South America", "Южная Европа": "Southern Europe", "Юго-Восточная Азия": "Southeast Asia", "Южная Африка": "Southern Africa"
  }
};
